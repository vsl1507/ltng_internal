...
export class NewsSourceService {
  async generateSourceConfigAI(sourceIdentifier: string): Promise<any> {
    ...
    try {
      ...
      return this.generateConfigWithAI(sourceIdentifier);
    }
  }
  ...
  /**
   * Source configuration generated by AI as JSON.
   */
  private async generateConfigWithAI(sourceIdentifier: string): Promise<any> {
...
Generate configuration for: ${sourceIdentifier}`;
  ...
  (source_type_id, source_name, source_identifier, source_config,
   source_is_active, source_is_trusted, source_country, created_by)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `,
      [
